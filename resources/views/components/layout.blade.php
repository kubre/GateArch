...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-174243951-2"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-174243951-2');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-NXF9NZS');</script>
...
<body>
        ...
        <div class="col-md-3 text-align mt-4 mt-md-0 mx-auto">
          ...
          <div class="mt-3 d-flex justify-content-center justify-content-md-start">
            <div class="mr-3">
                ...
                <p style="color: #afafaf">+91-9976591008</p>
            </div>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NXF9NZS"
