            ...
            <a style="display: block" href="{{ route('posts', [$post->id, $post->slug]) }}">
                <div class="container-fluid d-flex flex-column justify-content-center pb-1 post-wrapper card">
                    <div class="card-body">
                        ...
                        <div class="mt-2 row">
                            <div class="d-flex align-items-center col-md-6"><span
                                    class="material-icons mr-2">today</span>Published On:
                                &nbsp;<strong>{{ $post->publish_date }}</strong></div>
                            <div class="d-flex align-items-center col-md-6"><span
                                    class="material-icons mr-2">person</span>Written By:
                                &nbsp;<strong>{{ $post->writer_name }}</strong></div>
                        </div>
                        <div class="d-flex align-items-center my-2"><span class="material-icons mr-2">label</span>Tags:
                            &nbsp;<strong>{{ $post->tags }}</strong></div>
                    </div>
                </div>
            </a>
        @endif
                    ...
                    <div class="col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-footer">
                                <div>
                                    <a href='{{ route('students.exams') }}'
                                        class='btn bg-gate-alt btn-info btn-sm text-white py-2 px-3'>More</a>
                                </div>
                            </div>
                        </div>
                    </div>
